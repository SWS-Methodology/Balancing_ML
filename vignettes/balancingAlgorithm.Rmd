---
title: "Balancing and standardization"
author: "Josh Browning & Marco Garieri"
date: "July 27, 2016"
output: pdf_document
---
...
temp = balancing(param1 = c(345000, 300000), param2 = c(0, 300000*0.15),
...
```{r, echo=FALSE, fig.width=7, fig.height=4, fig=TRUE}
temp = balancing(param1 = c(345000, 300000), param2 = c(345000*.1, 300000*0.15),
          sign = c(1, -1), plot = TRUE, plotSigma = 2)
temp = prettyNum(temp, digits = 2, format = "g", big.mark = ",")
```
